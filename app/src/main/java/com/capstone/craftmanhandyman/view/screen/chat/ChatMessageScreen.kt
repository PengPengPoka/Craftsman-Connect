...
import com.capstone.craftmanhandyman.ui.component.ChatBubble
import com.capstone.craftmanhandyman.ui.navigation.Screen
import com.capstone.craftmanhandyman.view.ViewModelFactory
    ...
    TopAppBar(
        ...
        title = {
            Row(
                ...
                IconButton(
                    onClick = { navHostController.navigate(Screen.ChatMessage.route){
                        popUpTo(0)
                    } }
                ) {
                    Image(
